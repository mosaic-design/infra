...
function createChangelogWriterOptions(changelogPath: string, presetWriterOptions: any, config: IReleaseTaskConfig) {
    ...
    return {
        ...
        mainTemplate: readFileSync(join(__dirname, '..', 'templates/changelog-root-template.hbs'), 'utf8'),
        commitPartial: readFileSync(join(__dirname, '..', 'templates/changelog-commit-template.hbs'), 'utf8'),
